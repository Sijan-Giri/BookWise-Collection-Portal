      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul>
              <li className="mb-2"><a href="#" className="hover:text-indigo-400 transition-colors duration-300">Home</a></li>
              <li className="mb-2"><a href="#" className="hover:text-indigo-400 transition-colors duration-300">Explore</a></li>
              <li className="mb-2"><a href="#" className="hover:text-indigo-400 transition-colors duration-300">My Library</a></li>
              <li className="mb-2"><a href="#" className="hover:text-indigo-400 transition-colors duration-300">Contact Us</a></li>
            </ul>
          </div>
          <div>
